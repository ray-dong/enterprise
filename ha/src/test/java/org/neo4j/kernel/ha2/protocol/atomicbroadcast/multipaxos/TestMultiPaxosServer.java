 ...
 * TODO
 */
public class TestMultiPaxosServer
    implements MessageProcessor
{
    ...
    protected final MultiPaxosServer server;
    protected final PaxosContext context;

    public TestMultiPaxosServer( String serverId )
    {
    ...
    public MultiPaxosServer getServer()
    {
        return server;
    }

    public void verifyState( Verifier<PaxosContext> verifier )
    {
    ...
    public TestMultiPaxosServer addStateTransitionListener(StateTransitionListener listener)
    {
