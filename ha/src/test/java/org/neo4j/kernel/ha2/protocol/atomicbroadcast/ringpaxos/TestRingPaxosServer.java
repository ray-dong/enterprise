 ...
 * TODO
 */
public class TestRingPaxosServer
    implements MessageProcessor
{
    ...
    protected final RingPaxosServer server;
    protected final RingPaxosContext ringPaxosContext;

    public TestRingPaxosServer( String serverId )
    {
        this.receiver = new TestMessageSource();
        this.sender = new TestMessageSender();

        ringPaxosContext = new RingPaxosContext();
        server = new RingPaxosServer( ringPaxosContext, receiver, sender, new TestFailureHandlerFactory() );
    ...
    public RingPaxosServer getServer()
    {
        return server;
    }

    public void verifyState( Verifier<RingPaxosContext> verifier )
    {
        verifier.verify( ringPaxosContext );
    }
    ...
    public TestRingPaxosServer addStateTransitionListener(StateTransitionListener listener)
    {
